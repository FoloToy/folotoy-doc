...
### Volume Config
    ...
    at+config=common,volume,<value> // Set the volume level, default to 60dB, with a range of values ranging from 50dB to 80dB
...
- Example: Changing the volume level to 50dB

  ```json
  at+config=common,volume,50dB
  ```
