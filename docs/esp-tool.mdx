...
2. 下载最新固件 https://github.com/FoloToy/folotoy-bin/releases 到 esptool 目录下面
3. 用随机附带的 USB 线连接好玩具和电脑，并且将玩具开机，在 Terminal 执行 ls -l /dev/tty* 中查看到串口设备，例如我的是 /dev/tty.usbserial-14210
...
2. 下载最新固件 https://github.com/FoloToy/folotoy-bin/releases 到 esptool-v4.6.2-macos 下面
